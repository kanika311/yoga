    ...
    >
      <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-3 md:px-8">
        <Link href="/" className="flex items-center gap-3">
          <Image src="/logo.png" alt="Heal-In Sutras" width={56} height={56} className="h-12 w-12 rounded-full object-cover ring-1 ring-gold/40 md:h-14 md:w-14" />
          <div className="leading-tight">
            <p className={`font-serif text-lg md:text-xl ${scrolled || open ? "text-forest" : "text-cream"}`}>Heal-In Sutras</p>
